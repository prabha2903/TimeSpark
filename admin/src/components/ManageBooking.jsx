...
import { bookingStyles,statusBadgeStyles,badgeBaseStyles,paymentBadgeBaseStyles,paymentBadgeStyles } from '../assets/dummyStyles'
...
axiosInstance.interceptors.request.use((cfg) => {
 ...
 const ManageBooking = () => {
  ...
  {/* Chevron icon overlayed inside the select */}
  <ChevronDown className={bookingStyles.filterSelectIcon} />
            ...
            {loading && <div className={bookingStyles.loadingText}>Loading bookings...</div>}
